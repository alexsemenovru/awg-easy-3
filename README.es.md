...
> Esta rama contiene el candidato **0.1.2-rc.2**. Las pruebas del servidor en VPS han pasado dentro del alcance del [informe de campo (en ruso)](docs/VPS_TEST_2026-08-30.ru.md); quedan la validación en el teléfono y las pruebas de OpenRC. La versión estable **0.1.1** no cambia. Consulte la [lista de pruebas del candidato (en ruso)](docs/RELEASE_TEST.ru.md). Las actualizaciones estables no instalan versiones RC.
