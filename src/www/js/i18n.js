...
window.awgI18n = (() => {
  const messages = {
    en: {
      ...
      qrAlt: 'AmneziaVPN profile QR code', profileNote: 'Show the profile link or download the configuration.',
    ...
    ru: {
      ...
      qrAlt: 'QR-код профиля AmneziaVPN', profileNote: 'Покажите ссылку профиля или скачайте конфигурацию.',
    ...
    es: {
      ...
      qrAlt: 'Código QR del perfil de AmneziaVPN', profileNote: 'Muestra el enlace del perfil o descarga la configuración.',
    ...
    'zh-cn': {
      ...
      qrAlt: 'AmneziaVPN 配置二维码', profileNote: '显示配置链接或下载配置文件。',
    ...
    fa: {
      ...
      qrAlt: 'کد QR پروفایل AmneziaVPN', profileNote: 'پیوند پروفایل را نمایش دهید یا فایل تنظیمات را بگیرید.',
