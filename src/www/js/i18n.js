...
window.awgI18n = (() => {
  const messages = {
    ...
    es: {
      ...
      namePlaceholder: 'Teléfono de un amigo', access: 'Acceso a la red', guestOption: 'Guest — solo internet',
    ...
    'zh-cn': {
      ...
      namePlaceholder: '朋友的手机', access: '网络访问权限', guestOption: 'Guest — 仅访问互联网',
