...
window.awgI18n = (() => {
  const messages = {
    en: {
      ...
      qrAlt: 'AmneziaVPN profile QR code', profileNote: 'Share the profile, copy its link, or download the configuration.',
      shareProfile: 'Share', copyProfile: 'Copy link', downloadConfig: 'Download .conf',
    ...
    ru: {
      ...
      qrAlt: 'QR-код профиля AmneziaVPN', profileNote: 'Поделитесь профилем, скопируйте ссылку или скачайте конфигурацию.',
      shareProfile: 'Поделиться', copyProfile: 'Копировать ссылку', downloadConfig: 'Скачать .conf',
    ...
    es: {
      ...
      qrAlt: 'Código QR del perfil de AmneziaVPN', profileNote: 'Comparte el perfil, copia el enlace o descarga la configuración.',
      shareProfile: 'Compartir', copyProfile: 'Copiar enlace', downloadConfig: 'Descargar .conf',
    ...
    'zh-cn': {
      ...
      qrAlt: 'AmneziaVPN 配置二维码', profileNote: '分享配置、复制链接或下载配置文件。',
      shareProfile: '分享', copyProfile: '复制链接', downloadConfig: '下载 .conf',
    ...
    fa: {
      ...
      qrAlt: 'کد QR پروفایل AmneziaVPN', profileNote: 'پروفایل را به اشتراک بگذارید، پیوند را کپی کنید یا فایل تنظیمات را بگیرید.',
      shareProfile: 'اشتراک‌گذاری', copyProfile: 'کپی پیوند', downloadConfig: 'دریافت .conf',
