...
> 本分支包含测试候选版本 **0.1.2-rc.2**。服务器端 VPS 测试已在[实测报告（俄语）](docs/VPS_TEST_2026-08-30.ru.md)所列范围内通过；手机验证和 OpenRC 测试仍待完成。稳定版 **0.1.1** 保持不变。请参阅[候选版本测试清单（俄语）](docs/RELEASE_TEST.ru.md)。正常的稳定版更新不会安装 RC 版本。
