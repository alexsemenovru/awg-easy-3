...
- Home-only mDNS и UPnP/SSDP Discovery. Управление портами через UPnP IGD, NAT-PMP и PCP, а также любой автоматический проброс портов намеренно не поддерживаются.
